...
bool graph_for_task_planner_msg__msg__point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("graph_for_task_planner_msg.msg._point.Point", full_classname_dest, 43) == 0);
  }
  graph_for_task_planner_msg__msg__Point * ros_message = _ros_message;
  {  // x
...
PyObject * graph_for_task_planner_msg__msg__point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("graph_for_task_planner_msg.msg._point");
