...
bool graph_for_task_planner_msg__msg__graph__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("graph_for_task_planner_msg.msg._graph.Graph", full_classname_dest, 43) == 0);
  }
  graph_for_task_planner_msg__msg__Graph * ros_message = _ros_message;
  {  // vertices
    ...
    if (!graph_for_task_planner_msg__msg__Point__Sequence__init(&(ros_message->vertices), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create graph_for_task_planner_msg__msg__Point__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    graph_for_task_planner_msg__msg__Point * dest = ros_message->vertices.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!graph_for_task_planner_msg__msg__point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // edges
    ...
    if (!graph_for_task_planner_msg__msg__Edge__Sequence__init(&(ros_message->edges), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create graph_for_task_planner_msg__msg__Edge__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    graph_for_task_planner_msg__msg__Edge * dest = ros_message->edges.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!graph_for_task_planner_msg__msg__edge__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * graph_for_task_planner_msg__msg__graph__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("graph_for_task_planner_msg.msg._graph");
  ...
  {  // vertices
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = graph_for_task_planner_msg__msg__point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // edges
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = graph_for_task_planner_msg__msg__edge__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
