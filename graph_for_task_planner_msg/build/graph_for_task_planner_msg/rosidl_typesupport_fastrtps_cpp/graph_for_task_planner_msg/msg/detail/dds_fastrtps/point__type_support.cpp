...
#include "graph_for_task_planner_msg/msg/detail/point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const graph_for_task_planner_msg::msg::Point & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  graph_for_task_planner_msg::msg::Point & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graph_for_task_planner_msg::msg::Point;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const graph_for_task_planner_msg::msg::Point *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<graph_for_task_planner_msg::msg::Point *>(
    untyped_ros_message);
...
{
  return &graph_for_task_planner_msg::msg::typesupport_fastrtps_cpp::_Point__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graph_for_task_planner_msg, msg, Point)() {
  return &graph_for_task_planner_msg::msg::typesupport_fastrtps_cpp::_Point__handle;
}
