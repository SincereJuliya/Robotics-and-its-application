...
#include "obstacles_msgs/msg/detail/obstacle_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const obstacles_msgs::msg::ObstacleMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  obstacles_msgs::msg::ObstacleMsg & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = obstacles_msgs::msg::ObstacleMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const obstacles_msgs::msg::ObstacleMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<obstacles_msgs::msg::ObstacleMsg *>(
    untyped_ros_message);
...
{
  return &obstacles_msgs::msg::typesupport_fastrtps_cpp::_ObstacleMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, obstacles_msgs, msg, ObstacleMsg)() {
  return &obstacles_msgs::msg::typesupport_fastrtps_cpp::_ObstacleMsg__handle;
}
