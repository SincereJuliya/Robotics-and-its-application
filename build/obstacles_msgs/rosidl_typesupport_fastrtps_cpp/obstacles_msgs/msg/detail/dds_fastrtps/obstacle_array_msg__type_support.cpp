...
#include "obstacles_msgs/msg/detail/obstacle_array_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const obstacles_msgs::msg::ObstacleMsg &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  obstacles_msgs::msg::ObstacleMsg &);
size_t get_serialized_size(
  const obstacles_msgs::msg::ObstacleMsg &,
  size_t current_alignment);
size_t
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      obstacles_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  obstacles_msgs::msg::ObstacleArrayMsg & ros_message)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      obstacles_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        obstacles_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        obstacles_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObstacleMsg(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = obstacles_msgs::msg::ObstacleArrayMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const obstacles_msgs::msg::ObstacleArrayMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<obstacles_msgs::msg::ObstacleArrayMsg *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_obstacles_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<obstacles_msgs::msg::ObstacleArrayMsg>()
{
  return &obstacles_msgs::msg::typesupport_fastrtps_cpp::_ObstacleArrayMsg__handle;
}
