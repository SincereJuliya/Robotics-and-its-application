...
static const _ObstacleMsg_type_support_symbol_names_t _ObstacleMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, obstacles_msgs, msg, ObstacleMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, obstacles_msgs, msg, ObstacleMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, obstacles_msgs, msg, ObstacleMsg)() {
  return &::obstacles_msgs::msg::rosidl_typesupport_c::ObstacleMsg_message_type_support_handle;
}
