...
static const _ObstacleArrayMsg_type_support_symbol_names_t _ObstacleArrayMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, obstacles_msgs, msg, ObstacleArrayMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, obstacles_msgs, msg, ObstacleArrayMsg)),
  }
};
...
{
  return &::obstacles_msgs::msg::rosidl_typesupport_cpp::ObstacleArrayMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, obstacles_msgs, msg, ObstacleArrayMsg)() {
  return get_message_type_support_handle<obstacles_msgs::msg::ObstacleArrayMsg>();
}
