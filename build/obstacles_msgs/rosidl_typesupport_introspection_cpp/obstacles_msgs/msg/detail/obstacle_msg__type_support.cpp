...
{
  new (message_memory) obstacles_msgs::msg::ObstacleMsg(_init);
}

void ObstacleMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<obstacles_msgs::msg::ObstacleMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleMsg_message_member_array[3] = {
  {
    ...
    offsetof(obstacles_msgs::msg::ObstacleMsg, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(obstacles_msgs::msg::ObstacleMsg, polygon),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(obstacles_msgs::msg::ObstacleMsg, radius),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObstacleMsg_message_members = {
  ...
  3,  // number of fields
  sizeof(obstacles_msgs::msg::ObstacleMsg),
...
{
  return &::obstacles_msgs::msg::rosidl_typesupport_introspection_cpp::ObstacleMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, obstacles_msgs, msg, ObstacleMsg)() {
  return &::obstacles_msgs::msg::rosidl_typesupport_introspection_cpp::ObstacleMsg_message_type_support_handle;
}
