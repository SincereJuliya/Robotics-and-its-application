...
#include "graph_for_task_planner_msg/msg/detail/edge__rosidl_typesupport_fastrtps_cpp.hpp"
...
// functions for graph_for_task_planner_msg::msg::Point already declared above
...
cdr_serialize(
  const graph_for_task_planner_msg::msg::Edge & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  graph_for_task_planner_msg::msg::Edge & ros_message)
{
  // Member: start_point
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graph_for_task_planner_msg::msg::Edge;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const graph_for_task_planner_msg::msg::Edge *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<graph_for_task_planner_msg::msg::Edge *>(
    untyped_ros_message);
...
{
  return &graph_for_task_planner_msg::msg::typesupport_fastrtps_cpp::_Edge__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graph_for_task_planner_msg, msg, Edge)() {
  return &graph_for_task_planner_msg::msg::typesupport_fastrtps_cpp::_Edge__handle;
}
