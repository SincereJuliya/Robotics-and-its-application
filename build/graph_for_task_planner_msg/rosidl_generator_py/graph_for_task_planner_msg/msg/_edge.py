...
class Edge(metaclass=Metaclass_Edge):
    ...
    _fields_and_field_types = {
        'start_point': 'graph_for_task_planner_msg/Point',
        'end_point': 'graph_for_task_planner_msg/Point',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['graph_for_task_planner_msg', 'msg'], 'Point'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['graph_for_task_planner_msg', 'msg'], 'Point'),  # noqa: E501
    )
